...
function Hero() {
  ...
  useEffect(() => {
    ...
    setStatus(hour24 >= 9 && hour24 < 24 ? "🟢 At office now" : "🔴 Not available now, sleeping");
  }, [time]);
  ...
  return (
    <section
      className={`
        relative h-screen w-full bg-cover bg-center bg-no-repeat text-white
        animate-none md:animate-none sm:animate-slide // 👈 mobile/tablet slide effect
      `}
      style={{ backgroundImage: "url('./rashel.jpeg')" }}
    >
      {/* Overlays */}
      ...
      <div className="relative z-10 h-full w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 flex flex-col justify-center">
        ...
        {/* === Hero Content === */}
        <div className="max-w-lg mt-20 md:mt-0">
          <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight mb-6">
            I build modern web products <br /> and market ideas.
          </h1>
          <p className="text-gray-300 mb-8">
